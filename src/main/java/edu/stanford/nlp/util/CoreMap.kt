 ...
 * [edu.stanford.nlp.ling.CoreAnnotations], but others may be defined elsewhere. See
 * [edu.stanford.nlp.ling.CoreAnnotations] for details.
 *
 ...
 * change this behavior (such as [HashableCoreMap]) must make sure that
 ...
 * @author rafferty
 */
interface CoreMap : TypesafeMap, PrettyLoggable, Serializable {
     ...
     * CoreMap.
     */
    fun toShorterString(vararg what: String?): String?
}