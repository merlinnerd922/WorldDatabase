...
interface TypesafeMap {
     ...
     * none is provided.
     */
    operator fun <VALUE> get(key: TSMKeyClass<VALUE>): VALUE?
     ...
     */
    operator fun <VALUE> set(key: TSMKeyClass<VALUE>, value: VALUE): VALUE?

    /**
     * Removes the given key from the map, returning the value removed.
     */
    fun <VALUE> remove(key: TSMKeyClass<VALUE>): VALUE
     ...
     */
    fun <VALUE> containsKey(key: TSMKeyClass<VALUE>): Boolean
